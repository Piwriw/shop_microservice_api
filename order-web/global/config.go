...
type AppConfig struct {
	...
	OrderGrpcServer     GrpcServer `json:"orderGrpcServer" yaml:"orderGrpcServer" mapstructure:"orderGrpcServer"`
	GoodGrpcServer      GrpcServer `json:"goodGrpcServer" yaml:"goodGrpcServer" mapstructure:"goodGrpcServer"`
	InventoryGrpcServer GrpcServer `json:"inventoryGrpcServer" yaml:"inventoryGrpcServer" mapstructure:"inventoryGrpcServer"`
